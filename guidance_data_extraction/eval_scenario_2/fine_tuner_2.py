...
SEED = int(sys.argv[4])
EXCEPT_ONE = int(sys.argv[5])

print(f'{OUTPUT_DIR = }, {LAST_ID = }, {EXCEPT_ONE = }')
...
for target in TARGETS:
    assert target != EXCEPT_ONE, f'{EXCEPT_ONE} should not be included.'
    ...
    if (os.path.getsize(target_dataset_path) > 3):
        ...
        dataset_train.append(shuffled_dataset['train'])
        dataset_validation.append(shuffled_dataset['train'])
